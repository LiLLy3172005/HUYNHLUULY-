...
private Button Search;
    ...
    public void handleSearch(ActionEvent event) {
        ...
        String nameToSearch = Find.getText().trim();
        ...
        if (!nameToSearch.isEmpty()) {
            ...
            try {
                ...
                String query = "SELECT * FROM IDCustomers WHERE Name = ?";
    ...
    private void loadDataFromDatabase() {
        try {
            ...
            /*    while (resultSet.next()) {
                    ...
                    IDCustomer idCustomer = new IDCustomer(Name, Phone, RoomNumber, RoomType, Bill, Date);
